...
<body>
	<h1>1. 기존 방식대로 스크립트릿과 표현식을 이용하여 각 scope에 담겨있는 값을 화면에 출력</h1>
	<%
	...
	<!-- 
	 ...
	 %>
	 pageScope에 감긴 값 : ${ scope } 또는 ${ pageScope.scope }<br>
	 requsetScope에 담긴 값 : ${ requestScope.scope }<br>
	 sessopmScope에 담긴 값 : ${ requestScope.scope }<br>
